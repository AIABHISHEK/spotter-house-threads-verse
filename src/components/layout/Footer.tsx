    ...
    <footer className="bg-accent text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Brand Column */}
          <div>
            <h3 className="text-xl font-bold mb-4">SPOTTER HOUSE</h3>
            <p className="text-sm mb-6">Empowering individuals to express their identity through trendy, customizable, and inclusive T-shirts.</p>
            <div className="flex space-x-4">
              <a href="#" className="bg-white text-accent rounded-full w-8 h-8 flex items-center justify-center">
            ...
            <form className="space-y-2">
              <div className="flex">
                <input type="email" placeholder="Your email address" 
                  className="py-2 px-4 rounded-l-full w-full focus:outline-none text-accent" />
                <button type="submit" 
                  className="bg-primary text-white py-2 px-4 rounded-r-full hover:bg-opacity-90 transition-colors">
                  Subscribe
                </button>
              </div>
            </form>
        ...
        <div className="border-t border-gray-600 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm">© {new Date().getFullYear()} Spotter House. All rights reserved.</p>
